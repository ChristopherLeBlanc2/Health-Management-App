...
export declare type AutocompleteListboxSlot = 'root';
...
export declare type AutocompleteListboxProps<D extends React.ElementType = AutocompleteListboxTypeMap['defaultComponent'], P = {
