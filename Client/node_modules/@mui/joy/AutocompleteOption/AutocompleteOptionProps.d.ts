...
export declare type AutocompleteOptionSlot = 'root';
...
export declare type AutocompleteOptionProps<D extends React.ElementType = AutocompleteOptionTypeMap['defaultComponent'], P = {
